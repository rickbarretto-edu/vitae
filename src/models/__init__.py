...
class AcademicBackground(SQLModel, table=True):
    ...
    researcher: "Researcher" = Relationship(back_populates="academic_background")
...
class KnowledgeArea(SQLModel, table=True):
    ...
    academic_background: "AcademicBackground" = Relationship(back_populates="knowledge_area")
